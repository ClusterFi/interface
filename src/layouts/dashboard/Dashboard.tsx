...
import { Heading, Container, Tabs as CustomTabs, NetworkSelection, Text, Button, Section, AnimatedButton } from "@/components";
					...
					<React.Fragment>
						...
						<div className={styles.inner}>
							...
							<div className={styles.row}>
								{Boolean(!isMobile || activeTab === tabs.supply) && <Deposits state={componentState} />}
								{Boolean(!isMobile || activeTab === tabs.borrow) && <Borrows state={componentState} />}
							</div>
						</div>
					</React.Fragment>
				)}
