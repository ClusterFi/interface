...
export const Market: React.FC<MarketProps> = ({ currency, name, isLoading }) => {
	return (
			...
			<Table className={styles.table}>
				...
				<Table.Body className={styles.body}>
					{mockedMarkets.map((market) => {
						return <MarketItem isLoading={isLoading} currency={market.currency} name={market.name} fullName={market.fullName} key={market.id} />;
					})}
				</Table.Body>
			</Table>
		</Section>
