...
const Item: React.FC<ItemProps> = ({ children, className, mobileTitle, ...rest }) => {
...
const ItemAsset: React.FC<ItemAssetProps> = ({ children, className, variant = "default", currency, primaryText, secondaryText, isLoading, ...rest }) => {
