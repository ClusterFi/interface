...
import { ReadMore, ReadMoreProps, StakingDeposit, StakingDepositProps, StakingWithdraw, StakingWithdrawProps, TreasurySwap, TreasurySwapProps, ConnectWallet, ConnectWalletProps, SelectToken, SelectTokenProps, Swap, SwapProps, SwitchWallet, SwitchWalletProps, Wallet, WalletProps, TabsModalProps, TabsModal, LoansProps, Loans } from "@/components/Modals/variants";
